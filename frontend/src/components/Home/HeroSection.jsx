...
export const HeroSection = () => {
    ...
    return (
        <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden">
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        {isAuthenticated ? (
                            <Link
                                to={ROUTES.DASHBOARD}
                                className="px-8 py-4 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 font-semibold text-lg transition-all transform hover:scale-105 flex items-center"
                            >
