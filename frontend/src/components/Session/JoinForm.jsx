...
export const JoinForm = ({ roomId, error, loading, onChange, onSubmit }) => {
    return (
            ...
            <form onSubmit={onSubmit} className="space-y-6">
                <div>
                    ...
                    <div className="relative">
                        ...
                        className="block w-full pl-12 pr-4 py-4 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 text-center text-xl font-mono tracking-wider transition-colors"
                        />
                    </div>
